<template>
  <div>
      <section class="min-h-screen flex items-stretch text-white ">
          <div class="lg:flex hidden w-1/2  bg-gray-500 bg-no-repeat bg-cover relative items-center" style="background-image: url(https://images.unsplash.com/photo-1577495508048-b635879837f1?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=675&q=80);">
              <div class="absolute bg-black opacity-60 inset-0 z-0"></div>
              <div class="w-full px-24 z-10">
                  <h1 class="text-5xl font-bold text-left tracking-wide">회원가입</h1>
                  <p class="text-3xl my-4">이름, 비밀번호, 비밀번호 확인</p>
              </div>
          ...
          <div class="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0" style="background-color: #161616;">
              ...
              <div class="w-full py-6 z-20">
                  ...
                  <div action="" class="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
                      <div class="pb-2 pt-4">
                          <input type="username" name="username" v-model="credentials.username" id="username" placeholder="사용자 이름을 입력해주세요." class="block w-full p-4 text-lg rounded-sm bg-black">
                      </div>
                      <div class="pb-2 pt-4">
                          <input class="block w-full p-4 text-lg rounded-sm bg-black" v-model="credentials.password1" type="password" name="password" id="password" placeholder="비밀번호를 입력해주세요.">
                      </div>
                      <div class="pb-2 pt-4">
                          <input class="block w-full p-4 text-lg rounded-sm bg-black" v-model="credentials.password2" @keyup.enter="signup2" type="password" name="passwordConfirmation" id="passwordConfirmation" placeholder="비밀번호 확인.">
                      </div>
                      <div class="px-4 pb-2 pt-4">
                          <button class="uppercase block w-full p-4 text-lg rounded-full bg-indigo-500 hover:bg-indigo-600 focus:outline-none" @click="signup">sign up</button>
                      </div>
                  </div>
              </div>
          </div>
